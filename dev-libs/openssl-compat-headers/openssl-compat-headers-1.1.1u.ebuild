...
PATCHES=(
	...
	"${FILESDIR}"/${PN/-compat-headers}-1.1.0j-parallel_install_fix.patch # bug #671602
	"${FILESDIR}"/${PN/-compat-headers}-1.1.1i-riscv32.patch
)
MULTILIB_WRAPPED_HEADERS=(
        usr/include/openssl-${PV}/openssl/opensslconf.h
)
...
multilib_src_compile() {
	emake include/openssl/opensslconf.h
}
...
multilib_src_install() {
	insinto /usr/include/openssl-${PV}/openssl
	doins -r include/openssl/*.h
}
